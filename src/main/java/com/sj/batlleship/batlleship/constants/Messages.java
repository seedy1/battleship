package com.sj.batlleship.batlleship.constants;
...
public class Messages{
    ...
    public static final String MISS_MESSAGE = "❌ Miss!";
    public static final String PLACE_SHIP_PROMPT = "🛳️ Place your next ship!";
